...
async function pageStudy(req, res) {
    ...
    if (!filters.subject || filters.weekday || filters.time) {
        return res.render("study.html", { filters, subjects, weekdays }) //vai renderizar essa pagina recebendo um obj e nesse obj posso ter mtos outros objt
    ...
    //caso haja erro na hora da consulta do obanco de dados
...
async function saveClasses(req, res) {
    ...
    const classScheduleValues = req.body.weekday.map(
        ...
        try {
            ...
            queryStrings += "&weekday=" + req.body.weekday[0]
            queryStrings += "&time=" + req.body.time_from[0] 
